...
PAGINA_URL = 'https://www.tiktok.com/search/video?q=#migracioncol'
...
lista_videos = "/html/body/div[1]/div[2]/div[2]/div[1]/div[2]/div/div/div[" #this is the main block of HTML (the point of reference or the body of the HMTL, the root of it) 
centinela = True
...
while centinela == True:
   try:
    ...
    user_name = driver.find_element(By.XPATH, value = lista_videos + str(i) + "]/div[2]/div/div[2]/a/div/p").text
    ...
    try:
       description = driver.find_element(By.XPATH, value = lista_videos + str(i) + "]/div[2]/div/div[1]").text
    ...
    print(str(i),"validation : ",user_name,description,link,date,views)

    d = {"description": description,"hashtags": hashtags_str, "user": user_name, "date":date, "link":link, "views": views}
    ...
    try:
      ...
      print('Finished')
      centinela = False
      base_final.to_excel('base_feed_test_migracol.xlsx',index=False)
      driver.close()
