...
##################################################################################################################
    ...
    path_archivo = 'base_columbia_tiktok_prueba.xlsx'
    ...
    workbook = openpyxl.load_workbook('base_columbia_tiktok_prueba.xlsx')
    ...
    workbook.save('base_columbia_tiktok_prueba.xlsx')
