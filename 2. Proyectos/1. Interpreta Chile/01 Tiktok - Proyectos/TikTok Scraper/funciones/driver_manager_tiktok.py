...
def ManagerDriverTiktok(VideoURL):
    ...
    if VideoURL is not None :
        ...
        pyautogui.moveTo(137, 625, duration=1.5) #Boton Inicio Sesion
        pyautogui.click()

        pyautogui.moveTo(709, 476, duration=0.5) #Boton inicio por numero o correo electronico
        pyautogui.click()

        pyautogui.moveTo(675, 393, duration=0.5) #Boton correo electronico
        pyautogui.click()
        

        # Encuentra los campos de entrada para el nombre de usuario y la contraseña
        username_input = driver.find_element(By.CSS_SELECTOR, "input[placeholder='Email or Username']")
        password_input = driver.find_element(By.XPATH, value = "//input[@placeholder='Contraseña']")

        # Ingresa tus credenciales de inicio de sesión
        username_input.send_keys("analiticadedatos.ordinola1@gmail.com")
        password_input.send_keys("Alonso1470@")
