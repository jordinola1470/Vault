...
async def main():
    ...
    df = pd.read_excel(r'C:\Users\Dell\Documents\BX-Codes\BX-Codes\01 Tiktok - Proyectos\Feed Selenium Project\columbia\videos_columbia.xlsx')
    urls = df['link'].tolist()
    ...
    base_final.to_excel(r'C:\Users\Dell\Documents\BX-Codes\BX-Codes\01 Tiktok - Proyectos\Feed Selenium Project\columbia\videos_columbia_metricas.xlsx')
